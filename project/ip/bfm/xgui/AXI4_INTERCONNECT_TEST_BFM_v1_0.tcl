...
proc init_gui { IPINST } {
	...
	set M00_ALEN_WIDTH  [ipgui::add_param $IPINST -parent $Page0 -name M00_ALEN_WIDTH ]
	set M00_ALOCK_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name M00_ALOCK_WIDTH]
...
proc update_PARAM_VALUE.M00_ALEN_WIDTH { PARAM_VALUE.M00_ALEN_WIDTH } {
	# Procedure called to update M00_ALEN_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.M00_ALEN_WIDTH { PARAM_VALUE.M00_ALEN_WIDTH } {
	# Procedure called to validate M00_ALEN_WIDTH
	return true
}

proc update_PARAM_VALUE.M00_ALOCK_WIDTH { PARAM_VALUE.M00_ALOCK_WIDTH } {
	# Procedure called to update M00_ALEN_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.M00_ALOCK_WIDTH { PARAM_VALUE.M00_ALOCK_WIDTH } {
	# Procedure called to validate M00_ALEN_WIDTH
	return true
}
